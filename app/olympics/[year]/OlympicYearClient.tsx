...
import { MedalRecord, OlympicEdition, Athlete, Team } from "@/types/olympics";

interface OlympicYearClientProps {
  edition: OlympicEdition;
  yearMedals: MedalRecord[];
  athletesInYear: Athlete[];
  teamsInYear: Team[];
  year: number;
}

export default function OlympicYearClient({
  edition,
  yearMedals,
  athletesInYear,
  teamsInYear,
  year,
}: OlympicYearClientProps) {
  ...
  return (
    <div className="container-wide py-12">
      ...
      {!yearMedals.length && athletesInYear.length > 0 && (
        <>
